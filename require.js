							...
							if (err) {
								...
								if ((this.events.error && this.map.isDefine)
									...
									return onError((this.error = err));
										...
										&& console.error) {
									// Log the error for debugging. If promises
									// could be
									// used, this would be different, but making
									// do.
									console.error(err);
								} else {
									// Do not want to completely lose the error.
									// While this
									// will mess up processing and lead to
									// similar results
									// as bug 1440, it at least surfaces the
									// error.
									req.onError(err);
								}
							}
